...
-- kalau kamu sudah punya makeRow/makeSmallButton global, boleh pakai itu.
-- di sini aku buat versi khusus Teleport Island biar tidak tabrakan.
...
do
    local row = makeTpIslandRow("Teleport Island Panel")  -- row di section kiri
