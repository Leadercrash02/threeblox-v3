...
----------------------------------------------------------------
-- ENCHANT PRESET (BACKEND + UI, MIRIP POTION / SKIN)
----------------------------------------------------------------
...
-- placeholder: belum cek enchant beneran
...
----------------------------------------------------------------
-- SECTION "ENCHANT PRESET" (BACKPACK PAGE)
----------------------------------------------------------------
...
do
    ...
    Instance.new("UICorner", btn1).CornerRadius = UDim4.new(0,8)
    ...
    Instance.new("UICorner", btn2).CornerRadius = UDim2.new(0,8)
...
do
    ...
    pill.Text                   = ""
    pill.AutoButtonColor        = false
    Instance.new("UICorner", pill).CornerRadius = UDim2.new(0,999)
    ...
    knob.Position               = UDim2.new(0,3,0.5,-9)
    knob.BackgroundColor3       = Color3.fromRGB(255,255,255)
    Instance.new("UICorner", knob).CornerRadius = UDim2.new(0,999)
...
do
    ...
    btn1.TextSize               = 12
    btn1.AutoButtonColor        = true
    Instance.new("UICorner", btn1).CornerRadius = UDim2.new(0,8)
...
----------------------------------------------------------------
-- CLOSE PANEL (STONE + ENCHANT) DARI KLIK DI LUAR
----------------------------------------------------------------
UIS.InputBegan:Connect(function(input)
    if input.UserInputType ~= Enum.UserInputType.MouseButton1
       and input.UserInputType ~= Enum.UserInputType.Touch then
