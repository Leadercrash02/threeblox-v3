...
-- LIST SKIN (UI) - TAMBAH NAMA BARU DI SINI
local SKINS = {
    -- Original
    "Eclipse Katana", "Holy Trident", "Soul Scythe",
    "Oceanic Harpoon", "Binary Edge", "The Vanquisher", "1x1x1x1 Ban Hammer",
    
    -- Tambahan baru - format harus sama persis dengan key di Animations module
    "Ethereal Sword",
    "Cursed Katana",
    "Blackhole Sword",
    "Gingerbread Katana",
...
AnimModule.GetAnimationData = function(self, animName)
    ...
    -- Format: "Skin Name - AnimationName" (contoh: "Ethereal Sword - RodThrow")
