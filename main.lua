...
--==================================================
-- SKIN ANIMATION SYSTEM - OPTIMIZED
--==================================================
...
local function equipSkinVisual(skinName)
...
closeBtn.Size, closeBtn.Position, closeBtn.BackgroundColor3, closeBtn.Text, closeBtn.TextColor3, closeBtn.Font, closeBtn.TextSize, closeBtn.ZIndex = UDim2.new(0, 22, 0, 22), UDim2.new(1, -26, 0.5, -11), Color3.fromRGB(180, 50, 50), "X", Color3.fromRGB(255, 255, 255), Enum.Font.GothamBold, 12, 12
...
UIS.InputBegan:Connect(function(input, gameProcessed)
    if not RightPanel.Visible or gameProcessed or (input.UserInputType ~= Enum.UserInputType.MouseButton1 and input.UserInputType ~= Enum.UserInputType.Touch) then return end
    local pos, absPos, absSize = input.Position, RightPanel.AbsolutePosition, RightPanel.AbsoluteSize
